...
IMAGES = [
    'assets/wallpaperuse.com-outrun-wallpaper-76590.png',
    'assets/wallpaperuse.com-synthwave-wallpaper-1003075.jpg',
    'assets/wallpaperuse.com-wallpapers-retro-803078.jpg',
    'assets/wallpaperuse.com-retro-wallpaper-hd-999925.png',
    'assets/31-synthwave-sun-waves-electronic-sky.jpg',
    'assets/city-5848267_1920.jpg'
]
...
def get_image():
    ...
    # open image
    with resources.open_binary('image_ascii_arusteph', IMAGES[n]) as fp:
        img = fp.read()
...
class Drive:
    def __init__(self):
        # open font resource
        with resources.open_binary('image_ascii_arusteph', 'assets/RobotoMono-VariableFont_wght.ttf') as fp:
            font = fp.read()
        # initialize font
